  ...
  return function (moduleArg = {}) {
      ...
      a.Md.push(function () {
        ...
        a.MakeSurface = function (b, c) {
          var d = {
            ...
            f = b * c * 4,
            k = a._malloc(f);
          if ((d = a.Surface._makeRasterDirect(d, k, 4 * b)))
            (d.me = null),
              (d.Ue = b),
              (d.Re = c),
              (d.Se = f),
        ...
        a.Surface.prototype.flush = function (b) {
          ...
          if (this.me) {
            ...
            b
              ...
              : this.me.getContext("2d").putImageData(c, 0, 0);
          }
        };
    ...
    (function (a) {
      ...
      a.Md.push(function () {
        ...
        function d(m) {
          return (
            m.naturalHeight || m.videoHeight || m.displayHeight || m.height
          );
        }
        function f(m) {
        ...
        a.deleteContext = function (m) {
          v === ia[m] && (v = null);
          "object" == typeof JSEvents && JSEvents.yf(ia[m].Ud.canvas);
        ...
        a.MakeOnScreenGLSurface = function (m, p, w, y, B, D) {
          ...
          p =
            void 0 === B || void 0 === D
              ? this._MakeOnScreenGLSurface(m, p, w, y)
              : this._MakeOnScreenGLSurface(m, p, w, y, B, D);
          if (!p) return null;
          p.Id = m.Id;
          return p;
        };
        a.MakeRenderTarget = function () {
          ...
          if (3 === arguments.length) {
            ...
            if (((p = this._MakeRenderTargetII(m, arguments[1])), !p))
              return null;
          } else return null;
          p.Id = m.Id;
          return p;
        ...
        a.MakeWebGLCanvasSurface = function (m, p, w) {
          ...
          if (
            ...
            throw "Canvas with id " + m + " was not found";
        ...
        a.Surface.prototype.makeImageFromTextureSource = function (m, p, w) {
          ...
          2 === v.version
            ...
            : y.texImage2D(y.TEXTURE_2D, 0, y.RGBA, y.RGBA, y.UNSIGNED_BYTE, m);
          l(y, p);
          this._resetContext();
    ...
    (function (a) {
      ...
      function c(g) {
        ...
        if (g instanceof Float32Array) {
          for (
            var e = Math.floor(g.length / 4), h = new Uint32Array(e), n = 0;
            n < e;
            n++
          )
            h[n] = b(g.slice(4 * n, 4 * (n + 1)));
          return h;
        }
      ...
      function m(g) {
        ...
        if (g instanceof Float32Array)
          (e.Rd = l(g, "HEAPF32")), (e.count = g.length / 4);
        else if (g instanceof Uint32Array)
          (e.Rd = l(g, "HEAPU32")), (e.colorType = a.ColorType.RGBA_8888);
        else if (g instanceof Array) {
          if (g && g.length) {
            for (
              var h = a._malloc(16 * g.length), n = 0, t = h / 4, x = 0;
              x < g.length;
              x++
            )
              for (var z = 0; 4 > z; z++) (a.HEAPF32[t + n] = g[x][z]), n++;
            g = h;
          } else g = M;
          e.Rd = g;
        } else
      ...
      function p(g) {
        ...
        if (g.length) {
          if (6 === g.length || 9 === g.length)
            return (
              l(g, "HEAPF32", H),
              6 === g.length && a.HEAPF32.set(fd, 6 + H / 4),
              H
            );
          if (16 === g.length)
            return (
      ...
      a.Malloc = function (g, e) {
        ...
        return {
          ...
          toTypedArray: function () {
            if (this.be && this.be.length) return this.be;
      ...
      a.onRuntimeInitialized = function () {
        function g(e, h, n, t, x, z, E) {
          z ||
            ...
            t.colorType === a.ColorType.RGBA_F16
              ? (z *= 2)
              : t.colorType === a.ColorType.RGBA_F32 && (z *= 4));
          var J = z * t.height;
          var I = x ? x.byteOffset : a._malloc(J);
          if (
            E ? !e._readPixels(t, I, z, h, n, E) : !e._readPixels(t, I, z, h, n)
          )
            return x || a._free(I), null;
        ...
        a.Path.MakeFromCmds = function (e) {
          var h = l(e, "HEAPF32"),
            n = a.Path._MakeFromCmds(h, e.length);
          k(h, e);
          return n;
        };
        a.Path.MakeFromVerbsPointsWeights = function (e, h, n) {
          var t = l(e, "HEAPU8"),
            x = l(h, "HEAPF32"),
            z = l(n, "HEAPF32"),
            E = a.Path._MakeFromVerbsPointsWeights(
              t,
              e.length,
              x,
              h.length,
        ...
        a.Path.prototype.addPath = function () {
          ...
          if (1 === e.length) this._addPath(h, 1, 0, 0, 0, 1, 0, 0, 0, 1, n);
          else if (2 === e.length)
            (e = e[1]),
              this._addPath(
                h,
        ...
        a.Path.prototype.conicTo = function (e, h, n, t, x) {
        ...
        a.Canvas.prototype.drawAtlas = function (e, h, n, t, x, z, E) {
          if (e && t && h && n && h.length === n.length) {
            ...
            var J = l(h, "HEAPF32"),
              ...
              V = l(c(z), "HEAPU32");
            if (E && "B" in E && "C" in E)
              this._drawAtlasCubic(e, I, J, V, U, x, E.B, E.C, t);
            else {
        ...
        a.Canvas.prototype.drawColorComponents = function (e, h, n, t, x) {
          a.Jd(this.Id);
          e = B(e, h, n, t);
        ...
        a.Canvas.prototype.drawImageOptions = function (e, h, n, t, x, z) {
          a.Jd(this.Id);
          this._drawImageOptions(e, h, n, t, x, z || null);
        };
        ...
        a.Canvas.prototype.drawImageRectOptions = function (e, h, n, t, x, z) {
          ...
          u(h, X);
          u(n, Ba);
          this._drawImageRectOptions(e, X, Ba, t, x, z || null);
        };
        ...
        a.getShadowLocalBounds = function (e, h, n, t, x, z, E) {
          ...
          n = l(n, "HEAPF32", Fb);
          t = l(t, "HEAPF32", Gb);
          if (!this._getShadowLocalBounds(e, h, n, t, x, z, X)) return null;
          h = na.toTypedArray();
          return E ? (E.set(h), E) : h.slice();
        };
        ...
        a.Canvas.prototype.getLocalToDevice = function () {
          ...
          for (var e = ca, h = Array(16), n = 0; 16 > n; n++)
            h[n] = a.HEAPF32[e / 4 + n];
          return h;
        };
        ...
        a.Canvas.prototype.writePixels = function (e, h, n, t, x, z, E, J) {
          if (e.byteLength % (h * n))
          ...
          I = l(e, "HEAPU8");
          h = this._writePixels(
            { width: h, height: n, colorType: E, alphaType: z, colorSpace: J },
            I,
            U,
            t,
            x
        ...
        a.ImageFilter.MakeDropShadowOnly = function (e, h, n, t, x, z) {
          x = y(x, va);
        ...
        a.ImageFilter.MakeImage = function (e, h, n, t) {
          ...
          t = u(t, Ba);
          if ("B" in h && "C" in h)
            return a.ImageFilter._MakeImageCubic(e, h.B, h.C, n, t);
          const x = h.filter;
        ...
        a.ImageFilter.MakeMatrixTransform = function (e, h, n) {
          e = p(e);
          if ("B" in h && "C" in h)
            return a.ImageFilter._MakeMatrixTransformCubic(e, h.B, h.C, n);
          const t = h.filter;
        ...
        a.Picture.prototype.makeShader = function (e, h, n, t, x) {
          t = p(t);
          x = u(x);
        ...
        a.Surface.prototype.makeSurface = function (e) {
          a.Jd(this.Id);
          e = this._makeSurface(e);
          e.Id = this.Id;
          return e;
        ...
        a.Surface.prototype.drawOnce ||
          (a.Surface.prototype.drawOnce = a.Surface.prototype.Qe);
        ...
        a.Md &&
          a.Md.forEach(function (e) {
            e();
          });
      };
      a.computeTonalColors = function (g) {
        var e = l(g.ambient, "HEAPF32"),
          h = l(g.spot, "HEAPF32");
      ...
      a.MakeImageFromEncoded = function (g) {
        ...
        var e = a._malloc(g.byteLength);
        a.HEAPU8.set(g, e);
        return (g = a._decodeImage(e, g.byteLength)) ? g : null;
      };
      var Ta = null;
        ...
        g.Md.push(function () {
          ...
          function h(q) {
            ...
            for (var A = [], P = 0; P < q.length; P += 5) {
              var Z = g.LTRBRect(q[P], q[P + 1], q[P + 2], q[P + 3]),
          ...
          function z(q) {
            ...
            q.foregroundColor &&
              (q._foregroundColorPtr = y(q.foregroundColor, I));
            q.backgroundColor &&
              (q._backgroundColorPtr = y(q.backgroundColor, U));
            q.decorationColor &&
              (q._decorationColorPtr = y(q.decorationColor, V));
            Array.isArray(q.fontFamilies) && q.fontFamilies.length
              ...
              : ((q._fontFamiliesPtr = M), (q._fontFamiliesLen = 0));
            if (q.locale) {
              var A = q.locale;
              q._localePtr = x(A);
              q._localeLen = ja(A);
            ...
            if (Array.isArray(q.shadows) && q.shadows.length) {
              ...
              for (
                var za = g._malloc(8 * A.length), Hb = za / 4, Ib = 0;
                Ib < A.length;
                Ib++
              ) {
              ...
              q._shadowBlurRadiiPtr = l(Z, "HEAPF32");
            ...
            Array.isArray(q.fontFeatures) && q.fontFeatures.length
              ? ((A = q.fontFeatures),
                ...
                (q._fontFeatureLen = A.length),
                (q._fontFeatureNamesPtr = t(P)),
                (q._fontFeatureValuesPtr = l(Z, "HEAPU32")))
              : ((q._fontFeatureLen = 0),
                (q._fontFeatureNamesPtr = M),
                (q._fontFeatureValuesPtr = M));
            Array.isArray(q.fontVariations) && q.fontVariations.length
              ? ((A = q.fontVariations),
                ...
                (q._fontVariationLen = A.length),
                (q._fontVariationAxesPtr = t(P)),
                (q._fontVariationValuesPtr = l(Z, "HEAPF32")))
              : ((q._fontVariationLen = 0),
                (q._fontVariationAxesPtr = M),
                (q._fontVariationValuesPtr = M));
          }
          function E(q) {
          ...
          g.Paragraph.prototype.getRectsForRange = function (q, A, P, Z) {
          ...
          g.Paragraph.prototype.getClosestGlyphInfoAtCoordinate = function (
            q,
            A
          ) {
          ...
          g.ParagraphStyle = function (q) {
            ...
            A.strutEnabled &&
            Array.isArray(A.fontFamilies) &&
            A.fontFamilies.length
              ? ((A._fontFamiliesPtr = t(A.fontFamilies)),
                (A._fontFamiliesLen = A.fontFamilies.length))
              : ((A._fontFamiliesPtr = M), (A._fontFamiliesLen = 0));
            ...
            q.textHeightBehavior =
              q.textHeightBehavior || g.TextHeightBehavior.All;
          ...
          g.ParagraphBuilder.prototype.setGraphemeBreaksUtf16 = function (q) {
            var A = l(q, "HEAPU32");
            this._setGraphemeBreaksUtf16(A, (q && q.length) || 0);
            k(A, q);
          };
      ...
      a.Md = a.Md || [];
      a.Md.push(function () {
        a.Canvas.prototype.drawText = function (g, e, h, n, t) {
          var x = ja(g),
            z = a._malloc(x + 1);
          ka(g, C, z, x + 1);
        ...
        a.Font.prototype.getGlyphBounds = function (g, e, h) {
          ...
          e = new Float32Array(a.HEAPU8.buffer, t, 4 * g.length);
          k(n, g);
        ...
        a.Typeface.MakeTypefaceFromData = function (g) {
          g = new Uint8Array(g);
          var e = l(g, "HEAPU8");
          return (g = a.Typeface._MakeTypefaceFromData(e, g.byteLength))
            ? g
            : null;
        };
        ...
        a.TextBlob.MakeOnPath = function (g, e, h, n) {
          if (g && g.length && e && e.countPoints()) {
            ...
            for (
              var z = e.next(), E = new Float32Array(4), J = 0;
              J < g.length && z;
              J++
            ) {
              var I = t[J];
      ...
      a.Md.push(function () {
        ...
        a.RuntimeEffect.prototype.makeShader = function (g, e) {
          var h = !g._ck,
            n = l(g, "HEAPF32");
          e = p(e);
          return this._makeShader(n, 4 * g.length, h, e);
        };
    ...
    var Aa = r.print || console.log.bind(console),
      Ca = r.printErr || console.error.bind(console);
    Object.assign(r, la);
    la = null;
    ...
    var gb = 0,
      ib = 0,
      jb = "undefined" != typeof TextDecoder ? new TextDecoder("utf8") : void 0,
      kb = (a, b, c) => {
        var d = b + c;
        for (c = b; a[c] && !(c >= d); ) ++c;
        ...
        for (d = ""; b < c; ) {
          ...
          if (f & 128) {
            var k = a[b++] & 63;
            if (192 == (f & 224)) d += String.fromCharCode(((f & 31) << 6) | k);
            else {
              var l = a[b++] & 63;
              f =
                224 == (f & 240)
                  ? ((f & 15) << 12) | (k << 6) | l
                  : ((f & 7) << 18) | (k << 12) | (l << 6) | (a[b++] & 63);
              65536 > f
    ...
    function yb(a, b, c = {}) {
      ...
      delete qb[a];
      ob.hasOwnProperty(a) &&
        ((b = ob[a]), delete ob[a], b.forEach((f) => f()));
    }
    function ub(a, b, c = {}) {
    ...
    var Mb = void 0,
      Nb = {};
    function Ob(a, b) {
      for (void 0 === b && Q("ptr should not be undefined"); a.Qd; )
        (b = a.ke(b)), (a = a.Qd);
      return Nb[b];
    }
    function Pb(a, b) {
      ...
      !!b.Td !== !!b.Pd &&
        sb("Both smartPtrType and smartPtr must be specified");
      b.count = { value: 1 };
    ...
    function Ub(a, b, c) {
      if (void 0 === a[b].Od) {
        var d = a[b];
        a[b] = function () {
          a[b].Od.hasOwnProperty(arguments.length) ||
            Q(
              `Function '${c}' called with an invalid number of arguments (${arguments.length}) - expects one of (${a[b].Od})!`
            );
    ...
    function Vb(a, b, c) {
      r.hasOwnProperty(a)
        ? ((void 0 === c || (void 0 !== r[a].Od && void 0 !== r[a].Od[c])) &&
    ...
    function Yb(a, b) {
      if (null === b)
        return this.Ae && Q(`null is not a valid ${this.name}`), 0;
      ...
      !this.oe &&
        ...
        Q(
          `Cannot convert argument of type ${
            b.kd.Td ? b.kd.Td.name : b.kd.Nd.name
    ...
    function bc(a, b) {
      ...
      b.kd.Nd.oe &&
        Q(
          `Cannot convert argument of type ${b.kd.Nd.name} to parameter type ${this.name}`
        );
      return Xb(b.kd.Kd, b.kd.Nd.Ld, this.Ld);
    }
    function cc(a, b, c, d, f, k, l, m, p, w, y) {
      ...
      f || void 0 !== b.Qd
        ? (this.toWireType = $b)
        : ((this.toWireType = d ? Yb : bc), (this.Sd = null));
    }
    function dc(a, b, c) {
      r.hasOwnProperty(a) || sb("Replacing nonexistant public symbol");
      void 0 !== r[a].Od && void 0 !== c
        ? (r[a].Od[c] = b)
        : ((r[a] = b), (r[a].ce = c));
    }
    var ec = (a, b) => {
    ...
    function mc(a, b) {
      ...
      "function" != typeof c &&
        Q(`unknown function pointer with signature ${a}: ${b}`);
      return c;
    }
    var nc = void 0;
    function oc(a) {
    ...
    function sc(a, b, c, d, f) {
      ...
      return function () {
        ...
        for (var F = 0; F < w; ++F)
          (y[F] = b[F + 2].toWireType(D, arguments[F])), B.push(y[F]);
        F = d.apply(null, B);
        if (m) mb(D);
        else
          for (var H = l ? 1 : 2; H < b.length; H++) {
            var T = 1 === H ? u : y[H - 2];
    ...
    function fa(a, b) {
      a.Zd ||
        ...
        (a.getContext = function (d, f) {
          f = a.Zd(d, f);
          return ("webgl" == d) == f instanceof WebGLRenderingContext
            ? f
            : null;
        }));
      var c =
    ...
    function jd(a, b) {
      var c = da(ia),
        d = { handle: c, attributes: b, version: b.majorVersion, Ud: a };
    ...
    function kd(a) {
      ...
      if (!a.gf) {
        ...
        2 <= a.version &&
          (b.Ge = b.getExtension("EXT_disjoint_timer_query_webgl2"));
        if (2 > a.version || !b.Ge)
          b.Ge = b.getExtension("EXT_disjoint_timer_query");
    ...
    function vd(a, b, c) {
      if (b) {
        ...
        if (void 0 === d)
          switch (((f = S.getParameter(a)), typeof f)) {
            case "number":
              d = f;
              break;
            case "boolean":
    ...
    function W(a) {
      ...
      if (b) {
        ...
        "number" == typeof c &&
          (b.je[a] = c =
            S.getUniformLocation(b, b.Me[a] + (0 < c ? "[" + c + "]" : "")));
        return c;
      }
      R(1282);
    }
    ...
    var Hd = (a, b, c, d) => {
      function f(u, F, H) {
        for (u = "number" == typeof u ? u.toString() : u || ""; u.length < F; )
          u = H[0] + u;
        return u;
      }
      function k(u, F) {
      ...
      function l(u, F) {
        ...
        var T;
        0 === (T = H(u.getFullYear() - F.getFullYear())) &&
          0 === (T = H(u.getMonth() - F.getMonth())) &&
          (T = H(u.getDate() - F.getDate()));
        return T;
      }
      function m(u) {
        switch (u.getDay()) {
      ...
      function p(u) {
        ...
        for (u = new Date(new Date(u.ae + 1900, 0, 1).getTime()); 0 < F; ) {
          var H = u.getMonth(),
            T = (Dd(u.getFullYear()) ? Ed : Fd)[H];
          if (F > T - u.getDate())
            (F -= T - u.getDate() + 1),
              u.setDate(1),
              11 > H
                ? u.setMonth(H + 1)
                : (u.setMonth(0), u.setFullYear(u.getFullYear() + 1));
          else {
        ...
        F = m(new Date(u.getFullYear(), 0, 4));
        H = m(H);
        return 0 >= l(F, u)
          ? 0 >= l(H, u)
            ? u.getFullYear() + 1
      ...
      w = {
        ...
        "%z": (u) => {
          ...
          return (
            (F ? "+" : "-") +
            String("0000" + ((u / 60) * 100 + (u % 60))).slice(-4)
          );
        },
        "%Z": (u) => u.uf,
        "%%": () => "%",
    ...
    cc.prototype.fromWireType = function (a) {
      function b() {
        return this.pe
          ? Pb(this.Ld.fe, { Nd: this.jf, Kd: c, Td: this, Pd: a })
          : Pb(this.Ld.fe, { Nd: this, Kd: a });
      }
      var c = this.bf(a);
      if (!c) return this.Ee(a), null;
      var d = Ob(this.Ld, c);
      if (void 0 !== d) {
        if (0 === d.kd.count.value)
          return (d.kd.Kd = c), (d.kd.Pd = a), d.clone();
        d = d.clone();
        this.Ee(a);
        return d;
      }
      ...
      return null === f
        ? b.call(this)
        : this.pe
        ? Pb(d.Ld.fe, { Nd: d, Kd: f, Td: this, Pd: a })
        : Pb(d.Ld.fe, { Nd: d, Kd: f });
    };
    ...
    r.count_emval_handles = function () {
      for (var a = 0, b = vc.Zd; b < vc.Wd.length; ++b)
        void 0 !== vc.Wd[b] && ++a;
      return a;
    };
    ...
    var $d = {
      ...
      D: function (a) {
        ...
        var c = b.Be,
          d = b.Xd,
          f = b.He,
          k = f.map((l) => l.ef).concat(f.map((l) => l.nf));
        tb([a], k, (l) => {
          var m = {};
          f.forEach((p, w) => {
            var y = l[w],
          ...
          return [
            {
              ...
              toWireType: function (p, w) {
                for (var y in m)
                  if (!(y in w)) throw new TypeError(`Missing field: "${y}"`);
                var B = c();
        ...
        tb([a, b, c], d ? [d] : [], function (F) {
          ...
          F = Tb(u, function () {
            if (Object.getPrototypeOf(this) !== ca)
              throw new xb("Use 'new' to construct " + y);
            if (void 0 === Y.Yd)
              throw new xb(y + " has no accessible constructor");
            var Ma = Y.Yd[arguments.length];
            if (void 0 === Ma)
              throw new xb(
                `Tried to invoke ctor of ${y} with invalid number of parameters (${
                  arguments.length
        ...
        tb([], [a], function (p) {
          ...
          tb([], m, function (D) {
            ...
            void 0 === B[b].Od
              ...
              : (B[b].Od[c - 1] = D);
            if (p.Ld.le)
              for (const u of p.Ld.le)
                u.constructor.hasOwnProperty(b) || (u.constructor[b] = D);
            return [];
          });
          return [];
        });
      ...
      a: function (a, b, c, d, f, k, l, m) {
        ...
        tb([], [a], function (w) {
          ...
          var D = w.Ld.fe,
            u = D[b];
          void 0 === u ||
          (void 0 === u.Od && u.className !== w.name && u.ce === c - 2)
            ? ((y.ce = c - 2), (y.className = w.name), (D[b] = y))
            : (Ub(D, b, B), (D[b].Od[c - 2] = y));
          tb([], p, function (F) {
            F = sc(B, F, w, k, l);
            void 0 === D[b].Od
              ? ((F.ce = c - 2), (D[b] = F))
      ...
      b: function (a, b, c) {
        ...
        d = Object.create(d.constructor.prototype, {
          value: { value: c },
          constructor: { value: Tb(`${d.name}_${b}`, function () {}) },
        });
        a.values[c] = d;
        a[b] = d;
      },
      ...
      o: function (a, b, c, d, f, k, l, m, p, w, y, B) {
        c = O(c);
        k = mc(f, k);
        m = mc(l, m);
        w = mc(p, w);
      ...
      O: function (a, b, c) {
        ...
        ub(a, {
          ...
          toWireType: function (p, w) {
            "string" != typeof w &&
              Q(`Cannot pass non-string to C++ string type ${c}`);
            var y = k(w),
              B = wd(4 + y + b);
            L[B >> 2] = y >> m;
            f(w, B + 4, y + b);
      ...
      p: function (a, b) {
        ...
        var k = Array(a - 1);
        f = Nc((l, m, p, w) => {
          for (var y = 0, B = 0; B < a - 1; ++B)
            (k[B] = c[B + 1].readValueFromPointer(w + y)),
              (y += c[B + 1].argPackAdvance);
          l = l[m].apply(l, k);
      ...
      wc: function (a, b, c, d) {
        2 <= v.version
          ? c && b
            ? S.bufferData(a, C, d, c, b)
            : S.bufferData(a, b, d)
          : S.bufferData(a, c ? C.subarray(c, c + b) : b, d);
      },
      vc: function (a, b, c, d) {
        2 <= v.version
          ? c && S.bufferSubData(a, b, C, d, c)
          : S.bufferSubData(a, b, C.subarray(d, d + c));
      },
      uc: function (a) {
      ...
      rc: function (a, b, c, d, f, k, l, m) {
        2 <= v.version
          ? S.de || !l
            ? S.compressedTexImage2D(a, b, c, d, f, k, l, m)
            : S.compressedTexImage2D(a, b, c, d, f, k, C, m, l)
          : S.compressedTexImage2D(
              ...
              f,
              k,
              m ? C.subarray(m, m + l) : null
            );
      },
      qc: function (a, b, c, d, f, k, l, m, p) {
        2 <= v.version
          ? S.de || !m
            ? S.compressedTexSubImage2D(a, b, c, d, f, k, l, m, p)
            : S.compressedTexSubImage2D(a, b, c, d, f, k, l, C, p, m)
      ...
      ic: function (a) {
        if (a) {
          var b = Xc[a];
          b ? (S.deleteProgram(b), (b.name = 0), (Xc[a] = null)) : R(1281);
        }
      },
      hc: function (a, b) {
        for (var c = 0; c < a; c++) {
      ...
      Tb: function (a, b, c, d, f, k, l) {
        S.Fe.drawElementsInstancedBaseVertexBaseInstanceWEBGL(
          a,
          b,
          c,
          d,
      ...
      Pb: function (a, b) {
        return (a = S.fenceSync(a, b))
          ? ((b = da(cd)), (a.name = b), (cd[b] = a), b)
          : 0;
      },
      Ob: function () {
        S.finish();
          ...
          if (a >= Vc) R(1281);
            ...
            if (!a.se)
              for (b = 0; b < S.getProgramParameter(a, 35718); ++b)
                a.se = Math.max(a.se, S.getActiveUniform(a, b).name.length + 1);
            K[c >> 2] = a.se;
          } else if (35722 == b) {
            if (!a.qe)
              for (b = 0; b < S.getProgramParameter(a, 35721); ++b)
                a.qe = Math.max(a.qe, S.getActiveAttrib(a, b).name.length + 1);
            K[c >> 2] = a.qe;
          } else if (35381 == b) {
            if (!a.re)
              for (b = 0; b < S.getProgramParameter(a, 35382); ++b)
                a.re = Math.max(
                  a.re,
                  S.getActiveUniformBlockName(a, b).length + 1
                );
            K[c >> 2] = a.re;
          } else K[c >> 2] = S.getProgramParameter(a, b);
        else R(1281);
      },
      vb: function (a, b, c) {
      ...
      sb: function (a, b, c) {
        c
          ? 35716 == b
            ...
            : 35720 == b
            ? ((a = S.getShaderSource($c[a])),
              (K[c >> 2] = a ? a.length + 1 : 0))
            : (K[c >> 2] = S.getShaderParameter($c[a], b))
          : R(1281);
      },
      S: function (a) {
        var b = dd[a];
      ...
      qb: function (a, b) {
        ...
        if ((a = Xc[a])) {
          ...
          if (!d)
            for (
              c.je = d = {}, c.Me = {}, k = 0;
              k < S.getProgramParameter(c, 35718);
              ++k
            ) {
          ...
          if (
            (f = a.Ne[f]) &&
            d < f[0] &&
            ((d += f[1]), (c[d] = c[d] || S.getUniformLocation(a, b)))
          )
            return d;
        } else R(1281);
        return -1;
      ...
      jb: function (a, b, c, d, f, k) {
        S.Je.multiDrawArraysInstancedBaseInstanceWEBGL(
          a,
          K,
          b >> 2,
          K,
      ...
      ib: function (a, b, c, d, f, k, l, m) {
        S.Je.multiDrawElementsInstancedBaseVertexBaseInstanceWEBGL(
          a,
          K,
          b >> 2,
          c,
      ...
      fb: function (a, b, c, d, f, k, l) {
        if (2 <= v.version)
          if (S.ye) S.readPixels(a, b, c, d, f, k, l);
          else {
            var m = zd(k);
            S.readPixels(
              a,
          ...
          (l = Ad(k, f, c, d, l)) ? S.readPixels(a, b, c, d, f, k, l) : R(1280);
      },
      eb: function (a, b, c, d) {
      ...
      Ta: function (a, b, c, d, f, k, l, m, p) {
        if (2 <= v.version)
          if (S.de) S.texImage2D(a, b, c, d, f, k, l, m, p);
          else if (p) {
            var w = zd(m);
            S.texImage2D(
              a,
              ...
              m,
              w,
              p >> (31 - Math.clz32(w.BYTES_PER_ELEMENT))
            );
          } else S.texImage2D(a, b, c, d, f, k, l, m, null);
        else S.texImage2D(a, b, c, d, f, k, l, m, p ? Ad(m, l, d, f, p) : null);
      },
      Sa: function (a, b, c) {
      ...
      Na: function (a, b, c, d, f, k, l, m, p) {
        if (2 <= v.version)
          if (S.de) S.texSubImage2D(a, b, c, d, f, k, l, m, p);
          else if (p) {
            var w = zd(m);
            S.texSubImage2D(
              a,
          ...
          } else S.texSubImage2D(a, b, c, d, f, k, l, m, null);
        else
          (w = null),
            p && (w = Ad(m, l, f, k, p)),
            S.texSubImage2D(a, b, c, d, f, k, l, m, w);
      },
      Ma: function (a, b) {
        S.uniform1f(W(a), b);
      },
      La: function (a, b, c) {
        if (2 <= v.version) b && S.uniform1fv(W(a), N, c >> 2, b);
        else {
          if (288 >= b)
            for (var d = Bd[b - 1], f = 0; f < b; ++f)
              d[f] = N[(c + 4 * f) >> 2];
      ...
      Ja: function (a, b, c) {
        if (2 <= v.version) b && S.uniform1iv(W(a), K, c >> 2, b);
        else {
          if (288 >= b)
            for (var d = Cd[b - 1], f = 0; f < b; ++f)
              d[f] = K[(c + 4 * f) >> 2];
      ...
      Ha: function (a, b, c) {
        if (2 <= v.version) b && S.uniform2fv(W(a), N, c >> 2, 2 * b);
        else {
          if (144 >= b)
            for (var d = Bd[2 * b - 1], f = 0; f < 2 * b; f += 2)
              (d[f] = N[(c + 4 * f) >> 2]),
                (d[f + 1] = N[(c + (4 * f + 4)) >> 2]);
      ...
      Fa: function (a, b, c) {
        if (2 <= v.version) b && S.uniform2iv(W(a), K, c >> 2, 2 * b);
        else {
          if (144 >= b)
            for (var d = Cd[2 * b - 1], f = 0; f < 2 * b; f += 2)
              (d[f] = K[(c + 4 * f) >> 2]),
                (d[f + 1] = K[(c + (4 * f + 4)) >> 2]);
      ...
      Da: function (a, b, c) {
        if (2 <= v.version) b && S.uniform3fv(W(a), N, c >> 2, 3 * b);
        else {
          if (96 >= b)
            for (var d = Bd[3 * b - 1], f = 0; f < 3 * b; f += 3)
              (d[f] = N[(c + 4 * f) >> 2]),
                (d[f + 1] = N[(c + (4 * f + 4)) >> 2]),
                (d[f + 2] = N[(c + (4 * f + 8)) >> 2]);
      ...
      Ba: function (a, b, c) {
        if (2 <= v.version) b && S.uniform3iv(W(a), K, c >> 2, 3 * b);
        else {
          if (96 >= b)
            for (var d = Cd[3 * b - 1], f = 0; f < 3 * b; f += 3)
              (d[f] = K[(c + 4 * f) >> 2]),
                (d[f + 1] = K[(c + (4 * f + 4)) >> 2]),
                (d[f + 2] = K[(c + (4 * f + 8)) >> 2]);
      ...
      za: function (a, b, c) {
        if (2 <= v.version) b && S.uniform4fv(W(a), N, c >> 2, 4 * b);
        else {
          if (72 >= b) {
            var d = Bd[4 * b - 1],
              f = N;
      ...
      xa: function (a, b, c) {
        if (2 <= v.version) b && S.uniform4iv(W(a), K, c >> 2, 4 * b);
        else {
          if (72 >= b)
            for (var d = Cd[4 * b - 1], f = 0; f < 4 * b; f += 4)
              (d[f] = K[(c + 4 * f) >> 2]),
                (d[f + 1] = K[(c + (4 * f + 4)) >> 2]),
                (d[f + 2] = K[(c + (4 * f + 8)) >> 2]),
                (d[f + 3] = K[(c + (4 * f + 12)) >> 2]);
      ...
      wa: function (a, b, c, d) {
        if (2 <= v.version)
          b && S.uniformMatrix2fv(W(a), !!c, N, d >> 2, 4 * b);
        else {
          if (72 >= b)
            for (var f = Bd[4 * b - 1], k = 0; k < 4 * b; k += 4)
              (f[k] = N[(d + 4 * k) >> 2]),
                (f[k + 1] = N[(d + (4 * k + 4)) >> 2]),
                (f[k + 2] = N[(d + (4 * k + 8)) >> 2]),
                (f[k + 3] = N[(d + (4 * k + 12)) >> 2]);
      ...
      va: function (a, b, c, d) {
        if (2 <= v.version)
          b && S.uniformMatrix3fv(W(a), !!c, N, d >> 2, 9 * b);
        else {
          if (32 >= b)
            for (var f = Bd[9 * b - 1], k = 0; k < 9 * b; k += 9)
              (f[k] = N[(d + 4 * k) >> 2]),
                (f[k + 1] = N[(d + (4 * k + 4)) >> 2]),
                (f[k + 2] = N[(d + (4 * k + 8)) >> 2]),
                (f[k + 3] = N[(d + (4 * k + 12)) >> 2]),
                ...
                (f[k + 7] = N[(d + (4 * k + 28)) >> 2]),
                (f[k + 8] = N[(d + (4 * k + 32)) >> 2]);
          else f = N.subarray(d >> 2, (d + 36 * b) >> 2);
          S.uniformMatrix3fv(W(a), !!c, f);
        }
      },
      ua: function (a, b, c, d) {
        if (2 <= v.version)
          b && S.uniformMatrix4fv(W(a), !!c, N, d >> 2, 16 * b);
        else {
          if (18 >= b) {
            var f = Bd[16 * b - 1],
              k = N;
    ...
    var wd = (r._malloc = (a) => (wd = r._malloc = G.cd)(a)),
      qc = (r._free = (a) => (qc = r._free = G.ed)(a)),
      pc = (a) => (pc = G.fd)(a);
    r.__embind_initialize_bindings = () =>
      (r.__embind_initialize_bindings = G.gd)();
    var ae = (a, b) => (ae = G.hd)(a, b),
      be = () => (be = G.id)(),
      ce = (a) => (ce = G.jd)(a);
    r.dynCall_viji = (a, b, c, d, f) => (r.dynCall_viji = G.ld)(a, b, c, d, f);
    r.dynCall_vijiii = (a, b, c, d, f, k, l) =>
      (r.dynCall_vijiii = G.md)(a, b, c, d, f, k, l);
    r.dynCall_viiiiij = (a, b, c, d, f, k, l, m) =>
      (r.dynCall_viiiiij = G.nd)(a, b, c, d, f, k, l, m);
    r.dynCall_iiiji = (a, b, c, d, f, k) =>
      (r.dynCall_iiiji = G.od)(a, b, c, d, f, k);
    ...
    r.dynCall_iiiij = (a, b, c, d, f, k) =>
      (r.dynCall_iiiij = G.sd)(a, b, c, d, f, k);
    r.dynCall_viij = (a, b, c, d, f) => (r.dynCall_viij = G.td)(a, b, c, d, f);
    r.dynCall_viiij = (a, b, c, d, f, k) =>
      (r.dynCall_viiij = G.ud)(a, b, c, d, f, k);
    r.dynCall_jiiiiii = (a, b, c, d, f, k, l) =>
      (r.dynCall_jiiiiii = G.vd)(a, b, c, d, f, k, l);
    r.dynCall_jiiiiji = (a, b, c, d, f, k, l, m) =>
      (r.dynCall_jiiiiji = G.wd)(a, b, c, d, f, k, l, m);
    r.dynCall_ji = (a, b) => (r.dynCall_ji = G.xd)(a, b);
    r.dynCall_iijj = (a, b, c, d, f, k) =>
      (r.dynCall_iijj = G.yd)(a, b, c, d, f, k);
    r.dynCall_iiji = (a, b, c, d, f) => (r.dynCall_iiji = G.zd)(a, b, c, d, f);
    r.dynCall_iijjiii = (a, b, c, d, f, k, l, m, p) =>
      (r.dynCall_iijjiii = G.Ad)(a, b, c, d, f, k, l, m, p);
    r.dynCall_iij = (a, b, c, d) => (r.dynCall_iij = G.Bd)(a, b, c, d);
    r.dynCall_vijjjii = (a, b, c, d, f, k, l, m, p, w) =>
      (r.dynCall_vijjjii = G.Cd)(a, b, c, d, f, k, l, m, p, w);
    r.dynCall_jiji = (a, b, c, d, f) => (r.dynCall_jiji = G.Dd)(a, b, c, d, f);
    r.dynCall_viijii = (a, b, c, d, f, k, l) =>
      (r.dynCall_viijii = G.Ed)(a, b, c, d, f, k, l);
    r.dynCall_iiiiij = (a, b, c, d, f, k, l) =>
      (r.dynCall_iiiiij = G.Fd)(a, b, c, d, f, k, l);
    r.dynCall_iiiiijj = (a, b, c, d, f, k, l, m, p) =>
      (r.dynCall_iiiiijj = G.Gd)(a, b, c, d, f, k, l, m, p);
    r.dynCall_iiiiiijj = (a, b, c, d, f, k, l, m, p, w) =>
      (r.dynCall_iiiiiijj = G.Hd)(a, b, c, d, f, k, l, m, p, w);
